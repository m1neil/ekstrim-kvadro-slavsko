import { s as slideUp, a as slideToggle, d as dataMediaQueries, b as bodyLock, c as bodyUnlock, e as bodyLockStatus, f as bodyLockToggle, g as gotoBlock, u as uniqArray, h as getHash } from "./common.min.js";
(function polyfill() {
...
document.querySelector("[data-burger]") ? window.addEventListener("load", menuInit) : null;
...
function formInit() {
  ...
  formSubmit();
  formFieldsInit();
  const phoneNumber = document.querySelector("[data-fls-phone]");
